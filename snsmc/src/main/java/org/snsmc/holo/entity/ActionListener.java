...
public interface ActionListener {
	default void onAttack(Player player, HoloEntity entity) {

	}

	default void onInteract(Player player, HoloEntity entity, Hand hand) {

	}

	default void onInteractAt(Player player, HoloEntity entity, Vector hitVec, Hand hand) {
