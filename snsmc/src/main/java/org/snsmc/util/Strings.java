...
public interface Strings {
	static String concateLine(String string, String separator) {
	...
	static String repeat(int codePoint, int length) {
		return new String(IntStream.iterate(codePoint, IntUnaryOperator.identity()).limit(length).toArray(), 0, length);
	}
}
