 ...
 */
package org.snsmc.packetwrapper;

import org.bukkit.World;
import org.bukkit.entity.Entity;
import org.bukkit.util.Vector;
import org.snsmc.util.NullsafeConverter;
...
public class WrapperPlayClientUseEntity extends AbstractPacket {
	...
	public Hand getHand() {
		return handle.getModifier()
			.withType(EnumWrappers.getHandClass(), new NullsafeConverter<>(EnumWrappers.getHandConverter())).read(0);
	}
	...
	public void setHand(Hand value) {
		handle.getModifier()
			.withType(EnumWrappers.getHandClass(), new NullsafeConverter<>(EnumWrappers.getHandConverter()))
			.write(0, value);
	}
}
